...
{
    public class SP_Get_TenantInfo_List : MM_Stored_Procedure
    {
        ...
        public SP_Get_TenantInfo_List(string requestedSP)
            : base(requestedSP)
        {
        ...
        public spResult ExecuteSP()
        {
            ...
            var myResult = new spR_Get_TenantsInfo_List_Result();
            ...
            try
            {
                using (var myAccessCommand = new SqlCommand(_storedProcedureName, _mySQLConn))
                {
                    ...
                    {
                        var rdrResult = Mapper.Map<List<TenantInfoDTO>>(dr);
        ...
        {
            // Parent - 
            Mapper.CreateMap<SafeDataReader, TenantInfoDTO>()
            ;
            // Child etc - 
        }
